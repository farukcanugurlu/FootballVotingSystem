...
namespace FootballVotingSystem.LogsDataSetTableAdapters {
    ...
    public partial class LogsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Logs` WHERE ((`UserID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Surname` IS NULL) OR (`Surname` = ?)) AND ((? = 1 AND `Birthdate` IS NULL) OR (`Birthdate` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Logs` SET `Username` = ?, `Password` = ?, `Name` = ?, `Surname` = ?, `Birthdate` = ?, `Email` = ? WHERE ((`UserID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Surname` IS NULL) OR (`Surname` = ?)) AND ((? = 1 AND `Birthdate` IS NULL) OR (`Birthdate` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, Username, [Password], Name, Surname, Birthdate, Email FROM Logs";
        ...
        public virtual int Delete(int Original_UserID, string Original_Username, string Original_Password, string Original_Name, string Original_Surname, global::System.Nullable<global::System.DateTime> Original_Birthdate, string Original_Email) {
        ...
        public virtual int Update(string Username, string Password, string Name, string Surname, global::System.Nullable<global::System.DateTime> Birthdate, string Email, int Original_UserID, string Original_Username, string Original_Password, string Original_Name, string Original_Surname, global::System.Nullable<global::System.DateTime> Original_Birthdate, string Original_Email) {
            if ((Username == null)) {
